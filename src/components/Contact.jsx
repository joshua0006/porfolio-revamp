  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="my-img"> <img src="./images/myimg.png" alt="" /></div>
        <div className="contact-card">

  <div className="social-buttons">
    <a href="https://github.com/joshua0006" className="social-button github">
      <svg
    ...
    <a href="https://www.linkedin.com/in/albert-joshua-magnase-4597b2280/" className="social-button linkedin">
      <svg
        viewBox="0 -2 44 44"
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a href="https://www.facebook.com/joshuamagnase" className="social-button facebook">
      <svg
        version="1.1"
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=magnasejoshua@gmail.com" className="social-button gmail">
